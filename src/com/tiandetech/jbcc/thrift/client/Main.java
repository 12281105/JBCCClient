...
public class Main {
	...
	public static void main(String[] args) throws TException {
    	...
    	*/
            ...
            //myJBCCClient.initializeClient("139.129.222.10", "/tdng_dw");
            ...
            */
            ...
            try
            {
            	JBCCResult thisresult = myJBCCClient.fastSelectFromTransaction("ABC", "studentid=100");
            ...
            System.out.println("Get Trans Count:"+myJBCCClient.getTransactionCount("ABC").getMessage());
            System.out.println("Get Block Count:"+myJBCCClient.getBlockCount("ABC").getMessage());
            
            
            try
            {
            	JBCCResult thatresult = myJBCCClient.fastSelectFromTransaction("ABC", "studentid=100", 5, 10);
            	String message = thatresult.getMessage();
            	QueryResult results = JSON.parseObject(message, QueryResult.class);
